...
namespace QuanLyDoAn.Areas.Admin.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccountId,UserName,Email,Password,ConfirmPassword,RoleId")] Account account)
        {
            string strMD5 = strPro.GetMD5(account.Password);
            if (account.Password == account.ConfirmPassword)
            {
                account.Password = strMD5;
                account.ConfirmPassword = strMD5;
            }
